                            ...
                            <div className="h-full p-1 md:mx-6">
                                <Card className="h-full flex flex-col p-0">
                                    <CardContent className="p-0 h-full flex">
                                        <div className="flex flex-col w-full md:flex-row justify-around flex-col-reverse md:flex-col h-full bg-[#1c2340] relative rounded-2xl shadow-md items-stretch px-6 md:px-12 text-white">
